                    ...
                    onClick={() => {
                      ...
                      if (automationLang === "hi") {
                        transcript = [
                          ...
                          { sender: "agent", text: `नमस्ते! मैं शिवालिक ग्रुप से बात कर रही हूँ। मुझे दिखा कि आपने हमारी परियोजना ${projText} में रुचि दिखाई थी और ${bhkText} फ़्लैट के विकल्प देख रहे थे। क्या यह आपसे बात करने का सही समय है?`, time: "0:18" },
